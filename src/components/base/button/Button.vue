<template>
  ...
  >
    ...
    <slot v-if="isLoading" name="loading">
      <FontAwesomeIcon :icon="faSpinner" spin fixed-width data-testid="loadingSpinner" class="mr-1" />
    </slot>
    ...
    <span v-else-if="hasPrefix" class="icon-prefix">
      <slot name="prefix">
        ...
        <FontAwesomeIcon v-else-if="prefixIcon" :icon="prefixIcon" fixed-width />
      </slot>
    </span>
    ...
    <span v-if="hasSuffix" class="icon-suffix">
      <slot name="suffix">
        ...
        <FontAwesomeIcon v-else-if="suffixIcon" :icon="suffixIcon" class="suffix-icon" fixed-width />
      </slot>
    </span>
  </button>
</template>
